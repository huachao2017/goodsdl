...
def find_contour(input_path, output_dir=None, debug_type=0, thresh_x = 120, morphology = False, overlapthresh=.3):
    ...
    return img, ret_minrectes


def _inner_find_one(image_path, output_dir, debug_type=2):
    time0 = time.time()
    _,min_rectes = find_contour(image_path, output_dir=output_dir, debug_type=debug_type, overlapthresh=.7)
