...
def prepare_train(data_dir, train_dir, train_name, fine_tune_checkpoint_dir, local_fineture, additional_data_dir=None):
    normal_examples_list, addition_examples, label_map_dict = read_examples_list_and_label_map_and_classnames(data_dir,additional_data_dir)
...
def prepare_rawdata_update_train(data_dir, train_dir, train_name):
    ...
    normal_examples_list, addition_examles_list, label_map_dict= read_examples_list_and_label_map_and_classnames(data_dir)
    logger.info(label_map_dict)
