...
class Image(models.Model):
    image_ground_truth = models.ForeignKey(ImageGroundTruth, related_name="ground_truth_images", default=None, null=True, on_delete=models.SET_NULL)
...
class TrainAction(models.Model):
    ...
    f_model = models.ForeignKey('TrainModel', related_name="child_trains", default=None, null=True, on_delete=models.SET_NULL)
