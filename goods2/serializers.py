...
from goods2.models import Deviceid, DeviceidPrecision, DeviceidExclude, Image, ImageGroundTruth, ImageResult, TrainImage, TrainAction, TrainModel, TrainActionUpcs, ImageTrainModel, TaskLog
